...
class AccountProviderDataSourceTest {
    ...
    fun `present - user change and reset`() = runTest {
        ...
        sut.flow.test {
            val initialState = awaitItem()
            assertThat(initialState.url).isEqualTo(AuthenticationConfig.DEFAULT_ACCOUNT_PROVIDER_URL)
            ...
            assertThat(resetState.url).isEqualTo(AuthenticationConfig.DEFAULT_ACCOUNT_PROVIDER_URL)
        }
    }
